...
* [Manage log data retention in Streams](../../../manage-data/streams/management/retention.md): Streams provides a single, centralized UI within {{kib}} that simplifies common tasks, including setting data retention. The **Retention** tab lets you manage how your stream retains data and provides insight into data ingestion and storage size.
