...
2. {applies_to}`serverless: ga` Set **Project scope** to choose which linked projects the job analyzes. Refer to [Set project scope when creating a job](/explore-analyze/machine-learning/anomaly-detection/ml-ad-run-jobs.md#ml-ad-cps-create).
