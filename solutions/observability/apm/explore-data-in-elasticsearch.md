...
Data streams, templates, and index-level operations can also be managed via {{kib}}'s [Index management](/manage-data/data-store/perform-index-operations.md#manage-indices) UI.
