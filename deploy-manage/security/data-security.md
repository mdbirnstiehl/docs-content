...
:::{note}
There is no encryption at rest out of the box for deployments orchestrated using {{ece}} and {{eck}}, or for self-managed clusters. You must instead configure disk-level encryption on your hosts. 
