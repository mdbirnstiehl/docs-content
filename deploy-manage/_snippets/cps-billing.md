...
* **Retained data volume:** The volume of data retained in your linked projects each month. The rate varies by the type of each linked project, such as Observability, Security, {{es}}, or {{es}} {{vectordb}}. For Observability linked projects, the rate also depends on the type of retained data.
