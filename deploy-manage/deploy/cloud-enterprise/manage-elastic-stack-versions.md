...
| Stack pack download link | Minimum required ECE version | Note
| --- | --- |
| [{{es}}, {{kib}}, and APM stack pack: 9.5.4](https://download.elastic.co/cloud-enterprise/versions/9.5.4.zip) | ECE 4.0.0 | Kibana requires 2GB instance
| [{{es}}, {{kib}}, and APM stack pack: 9.5.3](https://download.elastic.co/cloud-enterprise/versions/9.5.3.zip) | ECE 4.0.0 | Kibana requires 2GB instance
| {{es}}, {{kib}}, and APM stack pack: 9.5.2 | ECE 4.0.0 | Unavailable due to a known issue. Review [the related KB article](https://ela.st/es-v95-replication-bug).
| {{es}}, {{kib}}, and APM stack pack: 9.5.1 | ECE 4.0.0 | Unavailable due to a known issue. Review [the related KB article](https://ela.st/es-v95-replication-bug).
| {{es}}, {{kib}}, and APM stack pack: 9.5.0 | ECE 4.0.0 | Unavailable due to a known issue. Review [the related KB article](https://ela.st/es-v95-replication-bug).
| [{{es}}, {{kib}}, and APM stack pack: 9.4.7](https://download.elastic.co/cloud-enterprise/versions/9.4.7.zip) | ECE 4.0.0 | Kibana requires 2GB instance
| [{{es}}, {{kib}}, and APM stack pack: 9.4.6](https://download.elastic.co/cloud-enterprise/versions/9.4.6.zip) | ECE 4.0.0 | Kibana requires 2GB instance
