...
* On {{eck}} and self-managed deployments, use the data view that matches your log shipping setup, such as the {{filebeat}} or {{agent}} output indices. For details, refer to [Enable stack monitoring on ECK deployments](/deploy-manage/monitor/stack-monitoring/eck-stack-monitoring.md) or [Enable stack monitoring for {{es}} on a self-managed cluster](/deploy-manage/monitor/stack-monitoring/elasticsearch-monitoring-self-managed.md).
