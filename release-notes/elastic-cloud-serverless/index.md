...
* Fixes an issue where schedules and conversations referencing outdated Elastic managed LLM connector IDs failed to execute or display correctly [#249891]({{kib-pull}}249891)
