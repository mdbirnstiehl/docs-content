...
You can also create classic streams directly in the [**Streams**](/manage-data/streams/streams.md) UI in {{kib}}. This provides a simpler alternative to the multi-step API-based approach described below.
:::
...
You can also use the [**Streams**](/manage-data/streams/streams.md) page to view the details of a data stream. The **Streams** page provides a centralized interface for managing your data in {{kib}}. Select a stream to view its details.
:::
