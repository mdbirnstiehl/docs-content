...
After adding enrich data to your source indices, use the [create enrich policy API](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-enrich-put-policy) or [Index Management in {{kib}}](/manage-data/ingest/transform-enrich/data-enrichment.md#manage-enrich-policies) to create an enrich policy.
...
3. Use the [delete enrich policy](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-enrich-delete-policy) API or [Index Management in {{kib}}](/manage-data/ingest/transform-enrich/data-enrichment.md#manage-enrich-policies) to delete the previous enrich policy.
