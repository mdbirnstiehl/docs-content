:::{dropdown} Style
Adjust the visual appearance of your area chart to control how the data series are labeled and displayed alongside your chart. Click {icon}`brush` to open the **Style** panel.
